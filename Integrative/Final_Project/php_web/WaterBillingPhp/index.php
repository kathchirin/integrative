    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner">
        ...
        <div style="height:500px;" class="card">
          <div style="background-size: cover; background-position: center;border-radius:100px;" class="card-body">
            <!-- Logo -->
            <div class="app-brand justify-content-center">
              <a href="" class="app-brand-link gap-2">
                <span style="text-transform:uppercase; text-align:center; font-weight:bold; color:#696cff; font-size:20px">BARANGAY BASAK <br> WATER-BILLING SYSTEM</span>
              </a>
            </div>
            <!-- /Logo -->
            <div style="text-align:center;font-family:Arial, Helvetica, sans-serif">
              <h4 style="font-size:30px;" class="bx bxs-user-circle"> LOGIN</h4><br> <br>
            </div>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if($username == "user" && $password == "billing"){
            ...
            <form id="formAuthentication" class="mb-3" action="" method="POST">
              ...
              <br>
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-100" name="log" type="submit">Sign in</button>
              </div>
            </form>
          </div>
        </div>
